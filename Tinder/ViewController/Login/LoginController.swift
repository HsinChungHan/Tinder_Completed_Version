...
class LoginController: UIViewController {
    ...
    fileprivate func setupLayout() {
        ...
        verticalStackView.anchor(top: nil, bottom: nil, leading: view.leadingAnchor, trailing: view.trailingAnchor, padding: .init(top: 0, left: 50, bottom: 0, right: 50), size: .zero)
